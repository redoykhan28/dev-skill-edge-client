    ...
    return (
        <div className='container'>
            ...
            <section className='section-3 my-5'>
                <div className="row">
                    <div className="col-md-6 heroHeading">
            ...
            <section className='success my-5'>
                <div className="row">
                    ...
                    <div className="col-lg-3 d-none d-lg-block">
                        <h1 className=' sText text-center my-5'>45+</h1>
                        <h1 className=' sText text-center my-5'>15k+</h1>
                        <h1 className=' sText text-center'>5+</h1>
                    </div>

                    <div className="col-md-5 my-5 mt-md-0">

                        <div className='mt-lg-4'>
                            <h4>Best & Most Involved Teachers
                            </h4>
                        ...
                        <div>
                            <h4>High-Quality Course Categories
                            </h4>
            ...
            <section className='my-5 projectBg'>
